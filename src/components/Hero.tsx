    ...
    <div className='max-w-[1440px] mx-auto space-y-12 py-8'>
      ...
      <section className="relative w-full h-[400px] md:h-[500px] rounded-[32px] overflow-hidden bg-gradient-to-br from-blue-600 to-blue-900 flex items-center px-8 md:px-16">
        <div className="max-w-xl space-y-6 z-10">
          ...
          <div className="pt-4">
            <Link href="/category">
              <button className="bg-orange-500 hover:bg-orange-600 text-white font-black py-4 px-10 rounded-2xl transition-all shadow-xl shadow-orange-500/20 active:scale-95">
                Explore Fleet
              </button>
            </Link>
          </div>
